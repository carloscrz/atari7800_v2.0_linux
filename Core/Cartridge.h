...
extern uint cartridge_Load(char* filename);
extern uint cartridge_Load_buffer(char* rom_buffer, int rom_size);
extern void cartridge_Store( );
extern void cartridge_StoreBank(byte bank);
extern void cartridge_Write(word address, byte data);
extern uint cartridge_IsLoaded( );
