...
#ifdef DEBUG
extern uint logger_Initialize( );
extern uint logger_Initialize(char* filename);
...
#else
static inline uint logger_Initialize() {}
static inline uint logger_Initialize(char* filename) {}
